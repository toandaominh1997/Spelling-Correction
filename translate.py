...
def main():
    ...
    parser.add_argument('--vocab', required=True, help='Path to vocab .pth file')
    parser.add_argument('--src', required=True, help='Source sequence to decode (one line per sequence)')
    parser.add_argument('--vocab', required=True, help='Source sequence to decode (one line per sequence)')
